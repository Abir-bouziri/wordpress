         ...
         'fields'           => array(
             ...
             array(
              ...
              array(
                  ...
                  'type'  => 'info',
                  'style' => 'success',
                  'title' => __('Header!', 'appai'),
                  'icon'  => 'el-icon-info-sign',
                  'required'   => array( 'menu_scheme', 'equals', 'custom-header' ),
                  'desc'  => __( 'Header - Before Scroll', 'appai')
              ),
              ...
              array(
                  'id'          => 'menu_item_color',
                  'type'        => 'color',
                  'title'       => esc_html__('Menu Item Color', 'appai'),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Menu Item Hover Color', 'appai'),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Background Color', 'appai'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom-header' ),
              ),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Menu Item Color', 'appai'),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Menu Item Hover Font Color', 'appai'),
              ...
              array(
                   ...
                   'icon'  => 'el-icon-info-sign',
                   'required'   => array( 'menu_scheme', 'equals', 'custom-header' ),
                   'desc'  => __( 'Header - After Scroll', 'appai')
              ),
              array(
